    ...
    return(
        <div className="about">
            <div className="container">
                <div className="title about__title">About us</div>
                <div className="about__wrapper">
                    <div className="student">
                        <a href="https://t.me/kasper_askar" target="_blank"><img className="student__img" src="https://cdn4.telesco.pe/file/myu082sYBgQyQu4TbErGK64jJaJRPgHTXGiRFNSuePJbOr-RL6i3V3SU6_Sx16-ylEitUFf1PK7JrUJIi_7OhhOAnui6PjWJCIOwnrxoj2mwl5N2FgpAiA19-ZhsNaj1OVNn3cWwfyrOyUl9LAkiabPuX876oF_ekw-S7iSD3I2sFeQjb88bIh75FMMftSwYvnAOdEXClw-5FIigEXXLhFJJEhgDZeNnsSbfSWvu4dVTWjP5MJKj74rOiRx70ls7guh6hHtsJZCyZNjEuWVZCXFmDx7t9Y5_-Elv8x8bEQe0h_mOndiUGDVb77QMl1jHeBvy_2oT6iFcBY6-49w5Vw.jpg" alt="user"/></a>
                        <h3 className="student__name">Baigenzhin Askar</h3>
                    </div>
                    <div className="student">
                        <a href="https://t.me/beibarysmoldabek" target="_blank"><img className="student__img" src="https://cdn4.telesco.pe/file/dCjZOXB-HjkP-WiMEReSuKCiLPu6GJX5-xKdNah6KgJ_brA-F9nNzVihSU7J4as-Dr9NBpKkjp-UDPbkoLAE9O_u7iy2FBxYfWwNOkhq3Qm8OwJfq8fe0iamY0MUjZPjDaklmzsT0grcUNkemKajXh4nkiPNbS2KSqp7YgfE8pm8N6PPWC_OLOjmGJoMKfJ-ByJH05_jbQV7zqXJDBAXhRyH8BQJHtougEkl-u3THxmtFuA4yTYazf8seEb48AhllDHwTAmCAs8Y7J3Z5AcuS9SMnyQbtk19MUVWemJHC1KW2hr8PiaHs1qZZjM5nrH2qU4KNnd6X-u_8UPxDzi9XA.jpg" alt="user"/></a>
                        <h3 className="student__name">Moldabekov Beibarys</h3>
                    </div>
                    <div className="student">
