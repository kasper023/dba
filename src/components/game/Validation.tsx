    ...
    return (
        <div className={"validation"}>
            <div className={"container"}>
                <form action="#">
                <input id="nick1" type="text" placeholder="Nickname for first user" onChange={(e) => {setNickname1(e.target.value)}} style={{
                    marginBottom:"20px",}} ref={textInput} required/> <br/>
                <input id="nick2" type="text" placeholder="Nickname for second user" onChange={(e) => {setNickname2(e.target.value)}} style={{
